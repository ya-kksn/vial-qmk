...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
      [_BASE] = LAYOUT(
         ...
         KC_ESC,  KC_Z,  KC_X,    KC_C,    KC_V,    KC_B,                                KC_N,    KC_M,  KC_COMM, KC_DOT, KC_QUOT, KC_MPLY,
               KC_VOLD,  KC_VOLU, KC_LCTL, LOWER,   KC_SPC, AU_TOGG,            CK_TOGG, KC_BSPC, RAISE, KC_RSFT, QK_REP, KC_RGUI 
      ...
      [_LOWER] = LAYOUT(
         ...
         _______, SLV_I,   SLV_SX,  APP_C,   SLV_SW,  SLV_H,                             KC_END,  PREVWRD, KC_PGDN, KC_PGUP, NEXTWRD,  _______,
