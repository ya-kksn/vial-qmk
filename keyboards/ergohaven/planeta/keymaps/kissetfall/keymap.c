...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
      [_BASE] = LAYOUT(
         ...
         KC_ESC,  KC_Z,  KC_X,    KC_C,    KC_V,    KC_B,                                KC_N,    KC_M,  KC_COMM, KC_DOT, KC_QUOT, KC_MPLY,
               KC_VOLD,  KC_VOLU, KC_LCTL, LOWER,   KC_SPC, KC_LBRC,            KC_RBRC, KC_BSPC, RAISE, KC_RSFT, QK_REP, KC_RGUI 
      ...
      [_LOWER] = LAYOUT(
         ...
         KC_ENT,  KC_LSFT, APP_S,   KC_DEL,  ALT_TAB, LALT(KC_LSFT),                     KC_HOME, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, _______,
      ...
      [_ADJUST] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______,                            _______, _______, _______, _______, _______, _______,
        _______, CK_RST,  CK_DOWN, CK_UP,   CK_TOGG, AU_TOGG,                            KC_CAPS, _______, KC_BRID, KC_BRIU, _______, _______,
