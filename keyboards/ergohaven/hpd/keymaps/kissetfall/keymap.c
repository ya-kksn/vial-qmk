...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
      [_BASE] = LAYOUT(
         ...
         KC_ESC,  KC_Z,  KC_X,    KC_C,    KC_V,    KC_B,                                KC_N,  KC_M,    KC_COMM, KC_DOT, KC_QUOT, KC_MPLY,
                         KC_VOLD, KC_VOLU, KC_LCTL, LOWER,                               RAISE, KC_RSFT, PREVWRD, NEXTWRD,
                                           KC_SPC,  KC_LSFT, KC_PGDN, KC_PGUP,    KC_LBRC, KC_RBRC,  KC_DEL, KC_BSPC                                 
      ...
      [_LOWER] = LAYOUT(
         ...
         _______, SLV_N,   SLV_SX,  APP_C,   SLV_SW,  SLV_H,                             KC_END,  KC_HOME, CTRLDN,  CTRLUP,  KC_END,  _______,
                           KC_MPRV, KC_MNXT, _______, _______,                           ADJUST, _______,  KC_PGDN, KC_PGUP, 
